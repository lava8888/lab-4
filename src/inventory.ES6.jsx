let inventory = {
  'Please select a foundation': { price: 0, foundation: true },
  'Please select a protein': { price: 0, protein: true },
  'Please select a dressing': { price: 0, dressing: true },
  Sallad: { price: 10, foundation: true, vegan: true },
  Pasta: { price: 10, foundation: true, gluten: true },


  'Sallad + "FAAAAAny"Pasta': { price: 10, foundation: true, gluten: true },
  ...
  Jalapeño: { price: 5, extra: true, vegan: true },
  ...
  Parmigiano: { price: 5, extra: true, lactose: true },
  ...
  'Pilsner Urquell': { price: 23, extra: true, vegan: true, gluten: true },
  'EY\' BRO': { price: 19, extra: true, vegan: true, gluten: true },
  'Corona': { price: 29, extra: true, vegan: true, gluten: true },
