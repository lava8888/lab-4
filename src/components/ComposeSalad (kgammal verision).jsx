...
class ComposeSalad extends Component {
  ...
  handleSubmit(event) {
    ...
    if (!this.props.inventory.length === 0) {
      propsFoundation = this.props.inventory[foundation];
      propsProtein = this.props.inventory[protein];
      propsDressing = this.props.inventory[dressing];
    }
    ...
    if (foundation !== 'Please select a foundation' && protein !== 'Please select a protein' && dressing !== 'Please select a dressing') {
      ...
      let mySalad = new Salad(this.props.inventory);
